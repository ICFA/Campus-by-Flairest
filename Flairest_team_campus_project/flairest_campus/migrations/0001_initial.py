# Generated by Django 5.0 on 2024-05-10 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(choices=[('очная', 'очная'), ('очно-заочная', 'очно-заочная'), ('заочная', 'заочная')], default='очная', max_length=40), null=True, size=None)),
                ('study_form', models.TextField(choices=[('очная', 'очная'), ('очно-заочная', 'очно-заочная'), ('заочная', 'заочная')], default='очная', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.CharField(default='10 Май 2024', editable=False)),
